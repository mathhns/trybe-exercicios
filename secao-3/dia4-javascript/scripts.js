...
function customerInfo(order) {
  return 'Olá ' + order.order.delivery.deliveryPerson + ', entrega para: ' + order.name + ', Telefone:' + order.phoneNumber + ', Endereço: ' + order.address.street + ', N°: ' + order.address.number + ' AP: ' + order.address.apartment;
}
